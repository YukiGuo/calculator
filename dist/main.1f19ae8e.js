...
var screen1 = document.querySelector('.screen1'); //上面的屏幕

var screen2 = document.querySelector('.screen2'); //下面的屏幕

var history = document.querySelector('.history'); //历史记录
...
keys.addEventListener("click", function (e) {
  ...
  var keyType = e.target.dataset.type;
  var keyContent = e.target.textContent;
  var screenNum1 = screen1.value;
  var screenNum2 = screen2.value;
  ...
  if (keyType === 'number') {
  ...
  } else if (keyType == "") {} else if (keyType === "decimal") {
    var a = screen2.value.substring(symbolIndex + 1);
    ...
    var answer = calculate(screenNum2);
    history.innerHTML += "<div>".concat(screenNum2, "=").concat(answer, "</div>");
    screen2.value = answer;
  }
});

var calculate = function calculate(expression) {
...
},{}],"../../software/nodejs/node_cache/_npx/12532/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../software/nodejs/node_cache/_npx/12532/node_modules/parcel/src/builtins/hmr-runtime.js","main.js"], null)
